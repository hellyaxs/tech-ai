      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              FITAI: Seu Personal<br className="hidden sm:inline" />Trainer Inteligente
            </h1>
            ...
            >
              Monitore seus treinos com visão computacional e receba feedback em tempo real sobre sua forma e técnica.
            </p>
